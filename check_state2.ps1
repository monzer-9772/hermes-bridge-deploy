...
Get-Process -Name "hermes*" -EA SilentlyContinue | Select-Object Id, ProcessName
Get-Process -Name "python*" -EA SilentlyContinue | Where-Object { $_.Path -like "*hermes*" } | Select-Object Id, ProcessName
